...
export SNDP_BTDM_SUPPORT ?= 1
ifeq ($(SNDP_BTDM_SUPPORT),1)
KBUILD_CPPFLAGS += -DSNDP_BTDM_SUPPORT
#KBUILD_CPPFLAGS += -DSNDP_DUMP_TX_DATA
#KBUILD_CPPFLAGS += -DSNDP_DUMP_RX_DATA
