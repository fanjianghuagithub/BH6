...
#define ICP1205_IIC_SCK_GPIO HAL_GPIO_PIN_P2_2
#define ICP1205_IIC_SDK_GPIO HAL_GPIO_PIN_P2_3
#define ICP1205_IIC_INT_GPIO HAL_GPIO_PIN_P1_1
...
//						full_chger_flg = true;
				...
				if((data_tmp[1]&0x0f)==0xE)
				{
					TRACE(3,"test cmd: battery %x", data_tmp[0]);
					I2C_MasterWriteData(ICP1205_DVCID,ICP1205_CRCOM_TDAT,&data_tmp[1],1);//回写
					hds_thread_msg_send(THREAD_MSG_UART_CMD_IPHONE_PAIRING);
				}			
...
static const struct HAL_GPIO_I2C_CONFIG_T i2c_cfg={ICP1205_IIC_SCK_GPIO,ICP1205_IIC_SDK_GPIO,20};
